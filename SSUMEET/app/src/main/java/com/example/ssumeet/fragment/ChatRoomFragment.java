...
import com.example.ssumeet.model.ChatRoomModel;
...
public class ChatRoomFragment extends Fragment {
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        RecyclerViewAdapter() {
            ...
            listenerUsers = firestore.collection("users").addSnapshotListener(new EventListener<QuerySnapshot>() {
                        @Override
                        public void onEvent(@Nullable QuerySnapshot value,
                            ...
                            for (QueryDocumentSnapshot doc : value) {
                                userList.put(doc.getId(), doc.toObject(ProfileModel.class));
                            }
                            getRoomInfo();
                        }
                    });
                            ...
                            for (final QueryDocumentSnapshot document : value) {
                                ...
                                if (users.size()==2) {
                                    for( String key : users.keySet() ){
                                        ...
                                        ProfileModel userModel = userList.get(key);
                                        chatRoomModel.setTitle(userModel.getName());
